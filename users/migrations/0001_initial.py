# Generated by Django 4.2.11 on 2024-04-05 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matric_number', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=12, max_length=10, prefix='IIC', unique=True)),
                ('paid_fees', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='matriculation_number', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
